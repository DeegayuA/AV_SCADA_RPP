...
export const dataPoints: ExtendedDataPoint[] = [
  ...
  {
    id: 'tempco', name: 'TEMPCO Setting', nodeId: 'ns=4;i=283', 
  ...
  {
    id: 'max-a-charge-battery-setting', name: 'Max Charge Current Setting', nodeId: 'ns=4;i=284', 
  ...
  {
    id: 'max-a-discharge-battery-setting', name: 'Max Discharge Current Setting', nodeId: 'ns=4;i=285', 
    dataType: 'Int16', uiType: 'display', icon: Settings, unit: 'A', category: 'settings', factor: 0.1, phase: 'x',
    description: 'Maximum allowed battery discharging current (e.g. raw 195 -> 19.5A).', label: '',
    isWritable: true,
  },
  {
    id: 'lithium-battery-wakeup-sign-bit', name: 'Lithium Battery Wakeup Signal Status', nodeId: 'ns=4;i=203', 
  ...
  {
    id: 'battery-resistance-value', name: 'Battery Resistance Value', nodeId: 'ns=4;i=204', 
  ...
  {
    id: 'battery-charging-efficiency-setting', name: 'Battery Charging Efficiency Setting', nodeId: 'ns=4;i=205', 
  ...
  {
    id: 'battery-capacity-shutdown-setting', name: 'Capacity Shutdown Setting (%)', nodeId: 'ns=4;i=206', 
  ...
  {
    id: 'battery-capacity-restart-setting', name: 'Capacity Restart Setting (%)', nodeId: 'ns=4;i=207', 
    dataType: 'Int16', uiType: 'display', icon: Settings, unit: '%', category: 'settings', factor: 1, phase: 'x',
    description: 'SoC (%) threshold to allow restart after shutdown (e.g. raw 50 -> 50%).', label: '',
    isWritable: true,
  },
  {
    id: 'battery-capacity-low-battery-setting', name: 'Capacity Low Battery Setting (%)', nodeId: 'ns=4;i=208', 
    dataType: 'Int16', uiType: 'display', icon: Settings, unit: '%', category: 'settings', factor: 1, phase: 'x',
    description: 'SoC (%) threshold to indicate low battery warning (e.g. raw 20 -> 20%).', label: '',
    isWritable: true,
  },
  {
    id: 'battery-voltage-shutdown-setting', name: 'Voltage Shutdown Setting', nodeId: 'ns=4;i=209', 
    dataType: 'Int16', uiType: 'display', icon: Settings, unit: 'V', category: 'settings', factor: 0.01, phase: 'x',
    description: 'Battery voltage threshold to trigger shutdown (e.g. raw 4600 -> 46.00V).', label: '',
    isWritable: true,
  },
  {
    id: 'battery-voltage-restart-setting', name: 'Voltage Restart Setting', nodeId: 'ns=4;i=210', 
    dataType: 'Int16', uiType: 'display', icon: Settings, unit: 'V', category: 'settings', factor: 0.01, phase: 'x',
    description: 'Battery voltage threshold to allow restart after shutdown (e.g. raw 5200 -> 52.00V).', label: '',
    isWritable: true,
  },
  {
    id: 'battery-voltage-low-battery-setting', name: 'Voltage Low Battery Setting', nodeId: 'ns=4;i=211', 
    dataType: 'Int16', uiType: 'display', icon: Settings, unit: 'V', category: 'settings', factor: 0.01, phase: 'x',
    description: 'Battery voltage threshold to indicate low battery warning (e.g. raw 4750 -> 47.50V).', label: '',
    isWritable: true,
  },
  {
    id: 'grid-charging-start-voltage-point-setting', name: 'Grid Charging Start Voltage Setting', nodeId: 'ns=4;i=213', 
    dataType: 'Int16', uiType: 'display', icon: Settings, unit: 'V', category: 'settings', factor: 0.01, phase: 'x',
    description: 'Battery voltage threshold below which grid charging can start (e.g. raw 4900 -> 49.00V).', label: '',
    isWritable: true,
  },
  {
    id: 'grid-charging-start-capacity-point-setting', name: 'Grid Charging Start Capacity Setting', nodeId: 'ns=4;i=214', 
    dataType: 'Int16', uiType: 'display', icon: Settings, unit: '%', category: 'settings', factor: 1, phase: 'x',
    description: 'Battery SoC (%) threshold below which grid charging can start (e.g. raw 40 -> 40%).', label: '',
    isWritable: true,
  },
  {
    id: 'grid-charge-battery-current-setting', name: 'Grid Charge Battery Current Setting', nodeId: 'ns=4;i=215', 
    dataType: 'Int16', uiType: 'display', icon: Settings, unit: 'A', category: 'settings', factor: 0.1, phase: 'x',
  ...
  { id: createId('Remote Start Key'), name: 'CMD: Remote Start', nodeId: 'ns=4;i=348', dataType: 'Boolean', uiType: 'button', icon: Power, description: 'Remote command to start operation.', category: 'control', factor: 1, phase: 'x', notes: 'Write-only.', label: '', isWritable: true },
  { id: createId('Remote Stop Key'), name: 'CMD: Remote Stop', nodeId: 'ns=4;i=349', dataType: 'Boolean', uiType: 'button', icon: Power, description: 'Remote command to stop operation.', category: 'control', factor: 1, phase: 'x', notes: 'Write-only.', label: '', isWritable: true },
  { id: createId('Remote Test Key'), name: 'CMD: Remote Test', nodeId: 'ns=4;i=350', dataType: 'Boolean', uiType: 'button', icon: Activity, description: 'Remote command to initiate a test sequence.', category: 'control', factor: 1, phase: 'x', notes: 'Write-only.', label: '', isWritable: true },
  { id: createId('Remote Auto Key'), name: 'CMD: Remote Auto Mode', nodeId: 'ns=4;i=351', dataType: 'Boolean', uiType: 'button', icon: Settings, description: 'Remote command to enable Auto mode.', category: 'control', factor: 1, phase: 'x', notes: 'Write-only.', label: '', isWritable: true },
  { id: createId('Remote Manual Key'), name: 'CMD: Remote Manual Mode', nodeId: 'ns=4;i=352', dataType: 'Boolean', uiType: 'button', icon: Settings, description: 'Remote command to enable Manual mode.', category: 'control', factor: 1, phase: 'x', notes: 'Write-only.', label: '', isWritable: true },
  { id: createId('Remote Mains C-O Key'), name: 'CMD: Remote Mains C/O', nodeId: 'ns=4;i=353', dataType: 'Boolean', uiType: 'button', icon: Waypoints, description: 'Remote command related to Mains changeover/connection.', category: 'control', factor: 1, phase: 'x', notes: 'C/O needs clarification. Write-only.', label: '', isWritable: true },
  { id: createId('Remote Gen C-O Key'), name: 'CMD: Remote Generator C/O', nodeId: 'ns=4;i=354', dataType: 'Boolean', uiType: 'button', icon: Waypoints, description: 'Remote command related to Generator changeover/connection.', category: 'control', factor: 1, phase: 'x', notes: 'C/O needs clarification. Write-only.', label: '', isWritable: true },
  { id: createId('Remote Up Key'), name: 'CMD: Remote Up', nodeId: 'ns=4;i=355', dataType: 'Boolean', uiType: 'button', icon: Activity, description: 'Remote command simulating an "Up" button press.', category: 'control', factor: 1, phase: 'x', notes: 'Write-only.', label: '', isWritable: true },
  { id: createId('Remote Down Key'), name: 'CMD: Remote Down', nodeId: 'ns=4;i=356', dataType: 'Boolean', uiType: 'button', icon: Activity, description: 'Remote command simulating a "Down" button press.', category: 'control', factor: 1, phase: 'x', notes: 'Write-only.', label: '', isWritable: true },
  { id: createId('Reserved i357'), name: 'Reserved (ns=4;i=357)', nodeId: 'ns=4;i=357', dataType: 'Boolean', uiType: 'display', icon: HelpCircle, description: 'Reserved data point.', category: 'status', factor: 1, phase: 'x', notes: 'Reserved.', label: '', isWritable: false },
  { id: createId('Reserved 1 i358'), name: 'Reserved_1 (ns=4;i=358)', nodeId: 'ns=4;i=358', dataType: 'Boolean', uiType: 'display', icon: HelpCircle, description: 'Reserved data point 1.', category: 'status', factor: 1, phase: 'x', notes: 'Reserved_1.', label: '', isWritable: false },
  { id: createId('Remote Confirm Key'), name: 'CMD: Remote Confirm', nodeId: 'ns=4;i=359', dataType: 'Boolean', uiType: 'button', icon: Activity, description: 'Remote command simulating a "Confirm/Enter" button press.', category: 'control', factor: 1, phase: 'x', notes: 'Write-only.', label: '', isWritable: true },
  { id: createId('Remote Mute Key'), name: 'CMD: Remote Mute', nodeId: 'ns=4;i=360', dataType: 'Boolean', uiType: 'button', icon: Activity, description: 'Remote command simulating a "Mute" button press.', category: 'control', factor: 1, phase: 'x', notes: 'Write-only.', label: '', isWritable: true },
  { id: createId('Reserved 2 i361'), name: 'Reserved_2 (ns=4;i=361)', nodeId: 'ns=4;i=361', dataType: 'Boolean', uiType: 'display', icon: HelpCircle, description: 'Reserved data point 2.', category: 'status', factor: 1, phase: 'x', notes: 'Reserved_2.', label: '', isWritable: false },
  { id: createId('Reserved 3 i362'), name: 'Reserved_3 (ns=4;i=362)', nodeId: 'ns=4;i=362', dataType: 'Boolean', uiType: 'display', icon: HelpCircle, description: 'Reserved data point 3.', category: 'status', factor: 1, phase: 'x', notes: 'Reserved_3.', label: '', isWritable: false },
  { id: createId('Remote Oil Engine Fast Stop'), name: 'CMD: Remote Oil Engine Fast Stop', nodeId: 'ns=4;i=363', dataType: 'Boolean', uiType: 'button', icon: AlertTriangle, description: 'Remote comand for fast stop of an oil engine.', category: 'control', factor: 1, phase: 'x', notes: 'Write-only.', label: '', isWritable: true },
  { id: createId('Reserved 4 i364'), name: 'Reserved_4 (ns=4;i=364)', nodeId: 'ns=4;i=364', dataType: 'Boolean', uiType: 'display', icon: HelpCircle, description: 'Reserved data point 4.', category: 'status', factor: 1, phase: 'x', notes: 'Reserved_4.', label: '', isWritable: false },
  { id: createId('Reserved 5 i365'), name: 'Reserved_5 (ns=4;i=365)', nodeId: 'ns=4;i=365', dataType: 'Boolean', uiType: 'display', icon: HelpCircle, description: 'Reserved data point 5.', category: 'status', factor: 1, phase: 'x', notes: 'Reserved_5.', label: '', isWritable: false },
  { id: createId('Reserved 6 i366'), name: 'Reserved_6 (ns=4;i=366)', nodeId: 'ns=4;i=366', dataType: 'Boolean', uiType: 'display', icon: HelpCircle, description: 'Reserved data point 6.', category: 'status', factor: 1, phase: 'x', notes: 'Reserved_6.', label: '', isWritable: false },
  
  // --- Meter Status (382-384) ---
  { id: createId('Meter Active Load Timer'), name: 'Meter Active Load Timer Status', nodeId: 'ns=4;i=382', dataType: 'Boolean', uiType: 'display', icon: Info, description: 'External Meter - Status of the Active Load Timer.', category: 'status', factor: 1, phase: 'x', label: '', isWritable: false },
  { id: createId('Meter Operation Timer 1'), name: 'Meter Operation Timer 1 Status', nodeId: 'ns=4;i=383', dataType: 'Boolean', uiType: 'display', icon: Info, description: 'External Meter - Status of Operation Timer 1.', category: 'status', factor: 1, phase: 'x', label: '', isWritable: false },
  { id: createId('Meter Cycle Count Status'), name: 'Meter Cycle Count Status', nodeId: 'ns=4;i=384', dataType: 'Boolean', uiType: 'display', icon: Info, description: 'External Meter - Status related to cycle counting functionality.', category: 'status', factor: 1, phase: 'x', label: '', isWritable: false },
