...
// --- Wind Turbine Data Points ---
{
    id: 'wind-turbine-status',
    name: 'Wind Turbine Status',
    nodeId: 'ns=5;s=WindTurbine.Status',
    dataType: 'Int16',
    uiType: 'display',
    icon: Info,
    description: 'Current status of the wind turbine. Requires lookup table.',
    category: 'wind',
    label: 'WT Status',
},
{
    id: 'wind-turbine-power-output',
    name: 'Wind Turbine Power Output',
    nodeId: 'ns=5;s=WindTurbine.PowerOutput',
    dataType: 'Float',
    uiType: 'display',
    icon: Power,
    unit: 'kW',
    description: 'Current power output of the wind turbine.',
    category: 'wind',
    label: 'WT Power',
},
{
    id: 'wind-turbine-wind-speed',
    name: 'Wind Turbine Wind Speed',
    nodeId: 'ns=5;s=WindTurbine.WindSpeed',
    dataType: 'Float',
    uiType: 'display',
    icon: Activity,
    unit: 'm/s',
    description: 'Current wind speed at the turbine.',
    category: 'wind',
    label: 'Wind Speed',
},
{
    id: 'wind-turbine-rpm',
    name: 'Wind Turbine RPM',
    nodeId: 'ns=5;s=WindTurbine.RPM',
    dataType: 'Float',
    uiType: 'display',
    icon: Activity,
    unit: 'rpm',
    description: 'Current RPM of the wind turbine rotor.',
    category: 'wind',
    label: 'WT RPM',
},

// --- Wind Inverter Data Points ---
{
    id: 'wind-inverter-status',
    name: 'Wind Inverter Status',
    nodeId: 'ns=5;s=WindInverter.Status',
    dataType: 'Int16',
    uiType: 'display',
    icon: Info,
    description: 'Current status of the wind inverter. Requires lookup table.',
    category: 'wind',
    label: 'W_INV Status',
},
{
    id: 'wind-inverter-power-output',
    name: 'Wind Inverter Power Output',
    nodeId: 'ns=5;s=WindInverter.PowerOutput',
    dataType: 'Float',
    uiType: 'display',
    icon: Power,
    unit: 'kW',
    description: 'Current power output of the wind inverter.',
    category: 'wind',
    label: 'W_INV Power',
},
{
    id: 'wind-inverter-temperature',
    name: 'Wind Inverter Temperature',
    nodeId: 'ns=5;s=WindInverter.Temperature',
    dataType: 'Float',
    uiType: 'display',
    icon: Thermometer,
    unit: '°C',
    description: 'Current internal temperature of the wind inverter.',
    category: 'wind',
    label: 'W_INV Temp',
},
