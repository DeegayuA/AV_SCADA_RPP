...
export const APP_DESCRIPTION = "A web-based plant monitoring system for real-time data visualization and control."; // Description of your app
export const APP_LOGO = logo; // Path to your app logo
export const APP_LOGO2 = logo2; // Path to your app logo
