...
const navDataConfig = {
  navMainBase: [
    ...
    { title: "Protocol Config", url: "/protocol-config", icon: Settings2, sectionId: "Protocol Config", colorKey: "settings" },
    { title: "Snap7 Test", url: "/snap7-test", icon: Activity, sectionId: "Snap7 Test", colorKey: "system" },
  ] as NavMainItemProps[],
