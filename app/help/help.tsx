...
const helpSectionsData: HelpSection[] = [
    {
        ...
        faqs: [
            { id: 'gs-what-is', question: `What is ${APP_NAME}?`, answer: `${APP_NAME} is an advanced Supervisory Control and Data Acquisition (SCADA) system specifically designed for solar minigrid and renewable energy installations. It empowers users with real-time monitoring, remote control capabilities, comprehensive data logging, and insightful analytics to ensure optimal performance, efficiency, and reliability of their energy systems.`, keywords: ['scada', 'solar', 'minigrid', 'overview', 'introduction'] },
            { id: 'gs-login', question: 'How do I log in and out?', answer: <p>To log in, navigate to the main login page and enter the credentials (email and password) provided by your system administrator. Ensure you are using a secure network. To log out, click on your user profile icon or name, typically located in the sidebar or header, and select the "Log out" option from the dropdown menu.</p>, keywords: ['access', 'sign in', 'sign out', 'credentials', 'authentication'] },
    ...
    },
    {
        ...
        faqs: [
            ...
            { id: 'dash-connection', question: 'Understanding PLC & WebSocket Status', answer: <span><Network className="mr-1 inline h-4 w-4 text-sky-500" /> **PLC Status** (e.g., Online, Offline, Disconnected) reflects the communication health with the physical Programmable Logic Controllers at the plant. If offline, real-time data and control are impacted. <Wifi className="ml-2 mr-1 inline h-4 w-4 text-green-500" /> **WebSocket Status** (e.g., Connected, Disconnected) indicates your browser's live data stream connection to the {APP_NAME} server. Both should be green/connected for optimal experience.</span>, keywords: ['connectivity', 'real-time data', 'plc', 'websocket', 'communication', 'online', 'offline'] },
