        ...
        <form onSubmit={handleSubmit} className="space-y-6 p-1">
          ...
          {(formData.type === 'read-one' || formData.type === 'read-range') && (
            <div>
              ...
              <Input id="nodeId" value={formData.nodeId || ''} onChange={(e) => handleChange('nodeId', e.target.value)} placeholder="ns=4;i=50" required={formData.type !== 'read-all'} className="mt-1"/>
