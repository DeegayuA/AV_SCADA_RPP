      ...
      <div className={`relative h-full w-full flex flex-col items-center justify-center overflow-hidden 
        ...
        >
          ...
          <motion.p variants={itemVariants(0.3, 30, 4)}
            ...
            Let's get your regenerative energy minigrid monitoring system up and running in just a few simple steps.
          </motion.p>

          <motion.div variants={itemVariants(0.35, 25, 3)} className="mb-8 w-full max-w-lg">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
              <div className="flex flex-col items-center p-3 rounded-lg bg-primary/10 border border-primary/20">
                ...
                <span className="text-center text-muted-foreground">Welcome</span>
              </div>
              <div className="flex flex-col items-center p-3 rounded-lg bg-muted/50 border border-border">
                <div className="w-8 h-8 rounded-full bg-muted-foreground/20 text-muted-foreground flex items-center justify-center font-bold mb-2">2</div>
                <span className="text-center text-muted-foreground">Plant Setup</span>
              </div>
              <div className="flex flex-col items-center p-3 rounded-lg bg-muted/50 border border-border">
                <div className="w-8 h-8 rounded-full bg-muted-foreground/20 text-muted-foreground flex items-center justify-center font-bold mb-2">3</div>
                <span className="text-center text-muted-foreground">Data Points</span>
              </div>
              <div className="flex flex-col items-center p-3 rounded-lg bg-muted/50 border border-border">
                <div className="w-8 h-8 rounded-full bg-muted-foreground/20 text-muted-foreground flex items-center justify-center font-bold mb-2">4</div>
                <span className="text-center text-muted-foreground">Review</span>
              </div>
            </div>
          </motion.div>
